...
import { filterFeaData, getfeaturesData, saveDataInLocalStorageFea } from "../../Redux/Features/action"
...
function Features(){
    ...
    const {isLoading, isError, fea_filter_data} = useSelector(state => state.fea, shallowEqual)
